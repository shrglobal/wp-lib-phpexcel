...
A wrapper plugin for the PHPExcel library.  This plugin only provides for loading the library; it does nothing else.
...
1. Begin using PHPExcel in your plugin or theme (e.g., `<?php $Excel = new PHPExcel(); ?>`
